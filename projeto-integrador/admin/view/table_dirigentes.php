<?php 
  ...
  $dirigentes = $table_controller->buscar_dirigentes();
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <?php
                      foreach ($dirigentes as $key => $a) {
                        echo "<tr>
                                <td>" . $dirigentes[$key]->get_nome() . "</td>
                                <td>" . $dirigentes[$key]->get_rg() . "</td>
                                <td>" . $dirigentes[$key]->get_siagep() . "</td>
                                <td>" . $dirigentes[$key]->get_data_nascimento() . "</td>
                                <td>" . utf8_encode($dirigentes[$key]->get_funcao()) . "</td>
                                <td>" . utf8_encode($dirigentes[$key]->get_equipe()) . "</td>
                              </tr>";
                      }
                    ?>
                  </tbody>
