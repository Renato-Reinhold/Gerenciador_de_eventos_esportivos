<?php
	...
	class EquipeDAO
	{
		...
		public function insert_estatisticas($equipe, $vitoria, $derrota, $empate, $gols){

			$sql_equipe = "INSERT into estatisticas_equipe(est_equ_equipe, est_equ_vitoria, est_equ_derrota, est_equ_empate, est_equ_gols) values(:equipe
			, :vitoria, :derrota, :empate, :gols)";
